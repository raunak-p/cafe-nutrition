...
source_data <- read.csv("../Data/JNIS_Secondary.csv", stringsAsFactors = FALSE)
...
for (iterator in  1:nrow(source_data)){
  ...
  render(input = "SecondaryRMD.Rmd", output_file = paste0("../Reports/", iterator, "_", subgroup$first_name, "_", subgroup$last_name, " ", "Report" , ".pdf"))
}