...
`r subgroup$first_name_c` has a total nutrition score of `r subgroup$total_p` out of 50 possible points. Read on to know what you're doing well and how you can get even better
...
Score <- c(subgroup$prot_p, 10 - subgroup$prot_p)
...
Score <- c(subgroup$dairy_p, 5 - subgroup$dairy_p)
...
Score <- c(subgroup$veg_p, 5 - subgroup$veg_p)
...
Score <- c(subgroup$fruit_p, 5 - subgroup$fruit_p)
...
Score <- c(subgroup$fast_p, 5 - subgroup$fast_p)
...
Score <- c(subgroup$sweet_p, 5 - subgroup$sweet_p)
...
Score <- c(subgroup$exercise_p, 5 - subgroup$exercise_p)
...
Water <- c(".", ".")
Type <- c("o", "l")
Score <- c(subgroup$water_p, 5 - subgroup$water_p)
...
protein_ba <- paste(subgroup$first_name_c, "needs to get more protein. Protein repairs your builds and repairs body tissue and organs, especially vital at this age. Proteins also form antibodies that help prevent infection, illness, and disease. The following foods contain protein:")
...
dairy_bb <- paste(subgroup$first_name_c, " is currently having more of dairy foods than what is needed at", subgroup$his_her, "age. Yes, dairy is good for growing children to help maintain strong teeth and bones, but including too much can mean filling up the children and increasing the chances that they forgo other nutrient rich foods. You could analyse the diet with the nutritionist and make the following changes if applicable:")
...
fast_g <- paste("Excellent! In comparison to other children,", subgroup$first_name_c, "'s intake of the processed and junk food is in check. These foods are high in fats and sugars and low in fiber. Healthy eating habits affects children’s physical, mental and physical growth through the essential growing years. And keeping a check on the intake now will only pave for a healthier life during adulthood.")
